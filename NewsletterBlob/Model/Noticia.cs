...
namespace NewsletterBlob.Model
{
    internal class Noticia
    {
        ...
        //Constructor
        public Noticia( int idAutor, string titulo,string subtitulo, string texto, byte[] imagem, string categoria, string autores, DateTime dataPublicacao)
        {
            this.titulo = titulo;
        ...
        public Noticia( int idAutor, string titulo, string subtitulo, string texto, byte[] imagem, string categoria, string autores, DateTime dataPublicacao, List<Comentario> comentarios, int qtdCurtidas)
        {
            this.titulo = titulo;
            this.subtitulo = subtitulo;
            this.texto = texto;
